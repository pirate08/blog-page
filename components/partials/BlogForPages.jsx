...
const BlogForPages = () => {
  ...
  return (
    <div className='w-full mx-auto py-10 px-4 md:px-24 bg-gradient-to-b from-blue-50 to-sky-50'>
      <div>
        {/* --Title-- */}
        <h1
      ...
      {/* --Tab Part-- */}
      <div className='mt-20 flex flex-wrap justify-center gap-2 md:gap-7 sm:px-0'>
        <Link href='/news-feed'>
      ...
      {/* --Sub-Tab Part-- */}
      <div className='mt-14 flex flex-wrap justify-center gap-2 md:gap-7 sm:px-0'>
